...
extension String {
	...
	static let duplicateRowsControlLabel = String(localized: "action.text.duplicate-rows", comment: "Action: Duplicate Rows")
	...
	static let enableOnMyDevice = String(localized: "action.text.enable-on-my-device", comment: "Label: Enable On My <Device>")
