...
extension String {
	...
	static let orangeControlLabel = String(localized: "Orange", comment: "Label: Orange")
	static let ownerControlLabel = String(localized: "Owner", comment: "Label: Owner")

	static let pasteControlLabel = String(localized: "Paste", comment: "Label: Paste")
	static let preferencesEllipsisControlLabel = String(localized: "Preferences…", comment: "Label: Preferences…")
	static let previousResultControlLabel = String(localized: "Previous Result", comment: "Label: Previous Result")
	static let pinkControlLabel = String(localized: "Pink", comment: "Label: Pink")
	static let primaryTextControlLabel = String(localized: "Primary Text", comment: "Label: Primary Text")
	static let printControlLabel = String(localized: "Print", comment: "Label: Print")
	static let printDocControlLabel = String(localized: "Print Doc", comment: "Label: Print Doc")
	static let printDocEllipsisControlLabel = String(localized: "Print Doc…", comment: "Label: Print Doc…")
	static let printListControlLabel = String(localized: "Print List", comment: "Label: Print List")
	static let printListControlEllipsisLabel = String(localized: "Print List…", comment: "Label: Print List…")
	static let privacyPolicyControlLabel = String(localized: "Privacy Policy", comment: "Label: Privacy Policy")
	static let purpleControlLabel = String(localized: "Purple", comment: "Label: Purple")

	static let quaternaryTextControlLabel = String(localized: "Quaternary Text", comment: "Label: Quaternary Text")

	static let redControlLabel = String(localized: "Red", comment: "Label: Red")
	static let readableControlLabel = String(localized: "Readable", comment: "Label: Readable")
	static let redoControlLabel = String(localized: "Redo", comment: "Label: Redo")
	static let releaseNotesControlLabel = String(localized: "Release Notes", comment: "Label: Release Notes")
	static let removeControlLabel = String(localized: "Remove", comment: "Label: Remove")
	...
	static let removeTagControlLabel = String(localized: "Remove Tag", comment: "Label: Remove Tag")
	static let renameControlLabel = String(localized: "Rename", comment: "Label: Rename")
	static let replaceControlLabel = String(localized: "Replace", comment: "Label: Replace")
	static let restoreControlLabel = String(localized: "Restore", comment: "Label: Restore")
	...
	static let rowIndentControlLabel = String(localized: "Row Indent", comment: "Label: Row Indent")
	static let rowSpacingControlLabel = String(localized: "Row Spacing", comment: "Label: Row Spacing")

	static let saveControlLabel = String(localized: "Save", comment: "Label: Save")
	static let scrollModeControlLabel = String(localized: "Scroll Mode", comment: "Label: Scroll Mode")
	static let searchPlaceholder = String(localized: "Search", comment: "Field Placeholder: Search")
	static let secondaryTextControlLabel = String(localized: "Secondary Text", comment: "Label: Secondary Text")
	static let selectControlLabel = String(localized: "Select", comment: "Label: Select")
	static let settingsControlLabel = String(localized: "Settings", comment: "Label: Settings")
	static let settingsEllipsisControlLabel = String(localized: "Settings…", comment: "Label: Settings…")
	static let shareControlLabel = String(localized: "Share", comment: "Label: Share")
	static let shareEllipsisControlLabel = String(localized: "Share…", comment: "Label: Share…")
	static let smallControlLabel = String(localized: "Small", comment: "Label: Small")
	static let sortDocumentsControlLabel = String(localized: "Sort Documents", comment: "Label: Sort Documents")
	static let sortRowsControlLabel = String(localized: "Sort Rows", comment: "Label: Sort Rows")
	static let splitRowControlLabel = String(localized: "Split Row", comment: "Label: Split Row")
	static let statisticsControlLabel = String(localized: "Statistics", comment: "Label: Statistics")
	static let syncControlLabel = String(localized: "Sync", comment: "Label: Sync")
	...
	static let tealControlLabel = String(localized: "Teal", comment: "Label: Teal")
	static let tertiaryTextControlLabel = String(localized: "Tertiary Text", comment: "Label: Tertiary Text")
	static let titleLabel = String(localized: "Title", comment: "Font Label: Title")
	static let titleControlLabel = String(localized: "Title", comment: "Label: Title")
	static let togglerSidebarControlLabel = String(localized: "Toggle Sidebar", comment: "Label: Toggle Sidebar")
	static let turnFilterOffControlLabel = String(localized: "Turn Filter Off", comment: "Label: Turn Filter Off")
	static let turnFilterOnControlLabel = String(localized: "Turn Filter On", comment: "Label: Turn Filter On")
	static let typingControlLabel = String(localized: "Typing", comment: "Label: Typing")
	static let typewriterCenterControlLabel = String(localized: "Typewriter", comment: "Label: Typewriter")
